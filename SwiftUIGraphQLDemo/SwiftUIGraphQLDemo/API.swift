...
public final class MediaPageQuery: GraphQLQuery {
  ...
  public let operationName: String = "MediaPage"
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public struct Page: GraphQLSelectionSet {
      ...
      public struct Medium: GraphQLSelectionSet {
        ...
        public init(id: Int, title: Title? = nil, coverImage: CoverImage? = nil, status: MediaStatus? = nil, description: String? = nil, seasonYear: Int? = nil, episodes: Int? = nil) {
          self.init(unsafeResultMap: ["__typename": "Media", "id": id, "title": title.flatMap { (value: Title) -> ResultMap in value.resultMap }, "coverImage": coverImage.flatMap { (value: CoverImage) -> ResultMap in value.resultMap }, "status": status, "description": description, "seasonYear": seasonYear, "episodes": episodes])
        }
